...
\title{Messa della morte}
\subtitle{Requiem e Kyrie\\(A-Wn Mus.Hs.16934)}
\scoring{S, A, T, B (solo), S, A, T, B (coro), cnto, fag, 2 clno (C), 2 trb, 2 vl, b, org}
\repository{edition-esser-skala/tuma-messa-della-morte}
\version{1.0.0}
\date{2021-11-06}
\maketitle
...
This edition bases upon a copy in the Austrian National Library. The digital version of the manuscript is available at \url{https://data.onb.ac.at/rec/AC14297556} (siglum Mus.Hs.16934; no RISM entry).

In general, this edition closely follows the manuscript. Any changes that were introduced by the editor are indicated by italic type (lyrics, dynamics and directions), parentheses (expressive marks and bass figures) or dashes (slurs and ties). Accidentals are used according to modern conventions.\footnote{Abbreviations: A, alto; B, bass; b, basses; clno, clarion; cnto, cornetto; Ms, manuscript; org, organ; r, rest; S, soprano; T, tenor; trb,~trombone; vl, violin.}
