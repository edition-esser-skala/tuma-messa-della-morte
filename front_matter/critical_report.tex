...
\scoring{S, A, T, B (coro), cnto, fag, 2 trb, 2 vl, b, org}
\maketitle
...
This edition bases upon a copy in the Austrian National Library. The digital version of the manuscript is available at \url{http://data.onb.ac.at/rec/AC14297556} (siglum Mus.Hs.16934; no RISM entry).
...
This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/tuma-messa-della-morte}. Your help will be greatly appreciated.
